...
namespace Tetris.Collision
{
    ...
    public static class VectorCollision
	{
         ...
         * 
         */
        public static bool HasVectorCollisionRight(List<Vector2> sourceList, List<Vector2> targetList)
        {
            return sourceList.Exists(
                source => targetList.Exists(target => source.X + 1 == target.X && source.Y == target.Y)
            );
        }
         ...
         * 
         */
        public static bool HasVectorCollisionLeft(List<Vector2> sourceList, List<Vector2> targetList)
        {
            return sourceList.Exists(
                source => targetList.Exists(target => source.X - 1 == target.X && source.Y == target.Y)
            );
         ...
         * 
         */
        public static bool HasVectorCollisionDown(List<Vector2> sourceList, List<Vector2> targetList)
        {
            return sourceList.Exists(
                source => targetList.Exists(target => source.Y + 1 == target.Y && source.X == target.X)
            );
        }
    }
